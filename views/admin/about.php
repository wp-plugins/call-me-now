<div class="wrap open-data">
	...
	<div class="section">
		<div class="grid-12" style="max-width: 800px">
			<h2><?php _e('Call Me Now', 'call_me_now') ?></h2>
			<p>Met deze plugin kun je eenvoudig een call me now knop toevoegen aan de website. Deze gegevens dienen ingevoerd te worden onder het tabblad <a href="admin.php?page=call_me_now_settings">Instellingen</a>.</p>
		</div>
	</div>
	...
	<div class="section info">
		<div class="grid-8">
			<h3><?php _e('Add widget', 'call_me_now') ?></h3>
			<div style="max-width: 600px">
				<p>De widget kan toegevoegd worden door naar <strong>Weergave</strong> en dan <strong>Widgets</strong> te gaan. Vervolgens kunt u hier de <strong>Call Me Now widget</strong> naar het gewenste widget gebied slepen. Door de widget uit te klappen, kan de widget aan wens aangepast worden.</p>
			</div>
		</div>
	...
	<div class="section info">
		<div class="grid-8">
			<h3><?php _e('Add shortcode', 'call_me_now') ?></h3>
			<div style="max-width: 600px">
				<p>Het is ook mogelijk om de <strong>Call Me Now</strong> in te sluiten in een pagina. Kopieer daarvoor de volgende code <strong>[call_me_now]</strong> en plak deze op de desbetreffende pagina.</p>
			</div>
		</div>
		<div class="grid-4" style="text-align: right">
